package pk.com.edu.uog.RegistrationServiceAPI.Services.web;
...
import pk.com.edu.uog.RegistrationServiceAPI.Services.service.UserService;
...
public class UserRegistrationController {
    ...
    public String registerUserAccount(@ModelAttribute("user") @Validated UserRegistrationDto userDto,
        ...
        if (existing != null){
            ...
            result.rejectValue("email", null, "Oops! There is already an account registered with that email");
        }
